  ...
  const engineers = [
    {
      ...
      email: "pastor.larry@hgcradio.org",
    },
    {
      id: "Kenny-Andrews",
      img: Team5,
      ...
      location: "United States",
      email: "kenny.andrews@hgcradio.org",
    },
    {
